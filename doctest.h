...
// ======================================================================
//
// doctest.h - the lightest feature-rich C++ single-header testing framework for unit_name tests and TDD
//
...
// this is here to clear the 'current test suite' for the current translation unit_name - at the top
...
// required includes - will go only in one translation unit_name!
#include <ctime>
#include <cmath>
#include <climits>
