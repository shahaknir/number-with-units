...
[כאן](http://mentalfloss.com/article/25845/quick-6-six-unit_name-conversion-disasters)).
...
* הקובץ כולל מספר פקודות של המרת-יחידות. כל פקודה מתחילה ב"1", ואז שם של יחידה, ואז סימן "=", ואז מספר כלשהו, ואז שם של יחידה אחרת. ראו דוגמה בקובץ [units.txt](units.txt).
   * יש רווח אחד או יותר לפני ואחרי הסימן "=".
   * יכולים להיות אפס או יותר רווחים בין המספר לבין שם היחידה שאחריו.
   * מספר היחידות לא יכול להיות 0.
